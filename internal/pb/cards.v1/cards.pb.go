...
const (
	...
	User_USER_OWNER       User = 1
	User_USER_PARTNER     User = 2
	User_USER_PLAYER1     User = 3
	User_USER_PLAYER2     User = 4
)
...
const file_cards_v1_cards_proto_rawDesc = "" +
	...
	"\x03pbn\x18\x01 \x01(\tR\x03pbn*b\n" +
	"\x04User\x12\x14\n" +
	"\x10USER_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"USER_OWNER\x10\x01\x12\x10\n" +
	"\fUSER_PARTNER\x10\x02\x12\x10\n" +
	"\fUSER_PLAYER1\x10\x03\x12\x10\n" +
	"\fUSER_PLAYER2\x10\x042h\n" +
